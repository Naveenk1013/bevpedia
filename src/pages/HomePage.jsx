...
const CATEGORY_CARDS = [
  ...
  { icon: MessageSquare, name: 'YAP Community', path: '/yap/community', count: 'Start Yapping', colour: '#7c5cfc', desc: 'Join exclusive hospitality messenging platform, you can yap here.' },
];
