            ...
            <header className="community-header">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <div style={{ display: 'flex', gap: '12px' }}>
                        <button className="btn outline flex items-center gap-2" onClick={() => setShowCreateModal(true)}>
                            <Plus size={18} /> Create
                        </button>
                        <button className="btn btn-primary flex items-center gap-2" onClick={() => navigate('/yap/community')}>
            ...
            <div className="groups-grid">
                {loading ? (
                    ...
                    <div className="text-muted" style={{ gridColumn: '1/-1', textAlign: 'center', padding: '60px' }}>
                        ...
                        <button className="btn outline" style={{ marginTop: '20px' }} onClick={() => navigate('/yap/community')}>
